...
describe("NFTMarketplace", function() {
    ...
    describe("Making marketplace items", function(){
        beforeEach(async function(){
            // addr1 mints
            await nft.connect(addr1).mint(URI);
            // addr1 approves marketplace to spend addr1's nft
        ...
        it("Should track newly created item, transfer NFt from seller to marketplace and emit offered event",async function(){
            ...
            cosnt item=await marketplace.items(1);
    ...
    describe("Purchasing marketplace items", function(){
        ...
        it("Should update item as sold, pay seller, transfer NFT to buyer, charge fees and emit a Bought event", async function(){
            ...
            let totalPriceWei=await marketplace.getTotalPrice(1);
            ...
            const free =(freePercent / 100) * price;

            expect(+fromWei(feeAccountFinalEthBal)).to.equal(+price + +fromWei(feeAccountFinalEthBal));
